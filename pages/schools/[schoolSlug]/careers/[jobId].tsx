...
const JobPostPage = () => {
    ...
    const [cpJobDetails, setCpJobDetails] = useState<JobDetail | undefined>(undefined);
                    ...
                    {cpJobDetails ? (
                        <>
                            ...
                            <div className='location d-lg-flex align-items-center'>
                                <p className='b4 mb-0'>{cpJobDetails.location.name}</p><span className='d-none d-lg-flex'>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                <p className='b4 mb-0'>{cpJobDetails.city}, {cpJobDetails.state}</p>
                            </div>
                            <p className='employment-type mt-2 mb-2'>{cpJobDetails.employment?.name}</p>
                            <div dangerouslySetInnerHTML={{ __html: cpJobDetails.description }}></div>
                        </>
                    ) : (
                        cmsJob && (
                            <>
                                ...
                                <p className='employment-type mt-2 mb-2'>{cmsJob.jobType || 'No Type'}</p>
                                <div dangerouslySetInnerHTML={{ __html: cmsJob.jobDescription }}></div>
                            </>
                        )
                    )}
                ...
                {cpJobDetails ? (
                    ...
                    cmsJob && (
                        <div className='aside'>
                            ...
                            {(!cmsJob?.applicationLink && cmsJob?.hiringManagerEmail) && (
                                <div className='email-resume-wrapper border-top border-bottom pt-5 pb-5'>
                                    <Button className='w-100 primary' href={`mailto:${cmsJob?.hiringManagerEmail}`}>Apply Now</Button>
                                </div>
                            )}
