...
export default function ThankYouPage({
        ...
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          <div className="close" onClick={onClose}>
            ...
            >
              <circle
                ...
                cy="10.5"
                r="9.75"
                transform="matrix(0.733776 0.679391 -0.733776 0.679391 15.8516 0.036377)"
                stroke="#858783"
                strokeWidth="1.5"
              />
              <rect
                width="1.28571"
                height="9"
                transform="matrix(0.733776 0.679391 -0.733776 0.679391 18.6797 10.8098)"
                fill="#5E6738"
              />
              <rect
                width="1.28571"
                height="9"
                transform="matrix(0.733776 -0.679391 0.733776 0.679391 12.082 11.6824)"
                fill="#5E6738"
              />
            </svg>
          </div>
          <div className="two-columns-image-and-text-alternative">
            ...
            <div className="right-column">
              ...
              <div className="b3 pb-3">
                {!franchiseOwner.multipleOwners
                  ? "Franchise Owner"
                  : "Franchise Owners"}
              </div>
              <div
  ...
  return (
    <div className="school thank-you">
      <script id="schoolpointerid">
        {school.schoolCorporateSettings.procarePointerId}
      </script>
      ...
      <script id="child_1_group" className="child-groups">
        {child1AgeGroup["group"]}
      </script>
      <script id="child_2_age">{child2AgeGroup["age"]}</script>
      <script id="child_2_group" className="child-groups">
        {child2AgeGroup["group"]}
      </script>
      <script id="child_3_age">{child3AgeGroup["age"]}</script>
      <script id="child_3_group" className="child-groups">
        {child3AgeGroup["group"]}
      </script>
      <script id="child_4_age">{child4AgeGroup["age"]}</script>
      <script id="child_4_group" className="child-groups">
        {child4AgeGroup["group"]}
      </script>
      <script id="child_5_age">{child5AgeGroup["age"]}</script>
      <script id="child_5_group" className="child-groups">
        {child5AgeGroup["group"]}
      </script>
      <script id="child_6_age">{child6AgeGroup["age"]}</script>
      <script id="child_6_group" className="child-groups">
        {child6AgeGroup["group"]}
      </script>
      <div className="container staff">
        ...
        <div className="resource-banner mt-3 mb-5 pt-4 pb-4 pt-lg-4 pb-lg-4 d-lg-flex justify-content-lg-between align-items-lg-center">
          <div className="d-flex flex-column flex-lg-row justify-center justify-content-lg-start align-items-center text-center w-100">
            <div className="icon-wrapper pe-lg-3 mb-3 mb-lg-0">
              ...
              >
                ...
                <g clipPath="url(#clip0_7076_75117)">
                  <path
                    d="M66.4028 82.6928C72.5613 82.2621 77.218 76.8953 77.218 70.7252V67.1279C77.218 64.6249 75.6115 62.4013 73.2365 61.6097L63.2479 58.2801V48.9668C63.2479 47.0342 61.6879 45.4742 59.7554 45.4742C57.8229 45.4742 56.2629 47.0342 56.2629 48.9668V68.7577L53.399 65.8938C51.1289 63.6237 47.4385 63.6237 45.1683 65.8938L44.6328 66.4294L57.3572 79.3167C59.639 81.5985 62.8754 82.9373 66.4145 82.6928H66.4028Z"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M65.5742 40.8059L69.0667 37.3134"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M67.9023 45.4625H72.559"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M51.6042 59.4327H28.3208C25.7479 59.4327 23.6641 57.3488 23.6641 54.776V33.8209C23.6641 31.2481 25.7479 29.1642 28.3208 29.1642H58.5892C61.1621 29.1642 63.2459 31.2481 63.2459 33.8209V36.1492"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M28.3203 33.8208L40.7188 45.6139C42.2555 47.0807 44.6653 47.0807 46.202 45.6139L58.6004 33.8208"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M39.3217 44.2983L28.3203 54.7759"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
            ...
            <Heading
              level="h4"
              className="ps-4 pe-4 pb-3 ps-lg-0 pe-lg-0 pb-lg-0 text-lg-start"
            >
              Sign up to get a preview of the curriculum and early education
              tips from Primrose.
            </Heading>
          </div>
          <div className="right">
          ...
          {franchiseOwner && (
            <div className="two-columns-image-and-text-alternative reverse-column">
              <div className="left-column col-12 col-lg-5 offset-lg-1">
                {franchiseOwner.image && (
                  <Image
                    ...
                    alt={
                      "Franchise Owner " + franchiseOwner.name ||
                      "feature image"
                    }
                    className="img-fluid"
                    width="500"
              ...
              <div className="right-column col-12 col-lg-5">
                ...
                <div
                  className="bio"
                  dangerouslySetInnerHTML={{ __html: franchiseOwner.bio }}
                />
          ...
          {meetOurStaff && (
            <div className="two-columns-image-and-text-alternative">
              ...
              <div className="right-column col-12 col-lg-4 offset-lg-1">
                ...
                <p className="b3">
                  When children feel safe, loved and confident, they can learn
                  and grow to their fullest potential. That’s why Primrose
                  school teachers and staff are dedicated to creating an
                  environment that helps lay the foundation for a lifelong love
                  of learning.
                </p>
                <Button href={`/schools/${schoolSlug}/staff`} target="self">
                  Read More
                </Button>
              </div>
            </div>
