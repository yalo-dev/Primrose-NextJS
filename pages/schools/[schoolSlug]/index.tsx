...
export default function SchoolMainPage({ school, schoolSlug }) {
    ...
    const renderHeroWithSlider = () => {
        ...
        if (schoolHoursFormatted.includes('Monday - Friday')) {
            schoolHoursFormatted = schoolHoursFormatted.replace('Monday - Friday', 'M-F');
        }
    ...
    const renderNewsSlider = () => {
        ...
        const newsHeading = school?.schoolSettings?.homepage?.news?.heading;
        const newsItems = school?.schoolSettings?.homepage?.news?.newsItems;
    ...
    const testimonialSection = () => {
        ...
        const { facebook, google, yelp } = school.schoolSettings.homepage.testimonials;
    ...
    const gallerySlider = () => {
        const galleryData = school.schoolSettings.homepage.gallery;
