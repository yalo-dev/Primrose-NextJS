		...
		<>
			<div className='resource'>
				...
				<div className='social d-flex justify-content-center flex-xl-column mt-4 mb-4 mt-xl-0'>
					<Link href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(resourceSlugProper)}`} target="_blank" rel="noopener noreferrer">
					...
					<Link href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(resourceSlugProper)}&title=${encodeURIComponent(resource.title)}&summary=${encodeURIComponent(resource.resourceFields.content?.substring(0, 150) || '')}&source=PrimroseSchools`} target="_blank" rel="noopener noreferrer">
