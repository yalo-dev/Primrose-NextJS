		...
		<>
			<div className='resource'>
				...
				<Link href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`} target="_blank" rel="noopener noreferrer">
					...
					<Link href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(resourceSlugProper)}&text=${encodeURIComponent(resource.title)}`} target="_blank" rel="noopener noreferrer">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<Link href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}`} target="_blank" rel="noopener noreferrer">
					...
					<div className='newsletter-form-cta'>
						<div className='row'>
							<div className='col-12 content'>
								<Heading level='h3'>{newsletterFormCta.heading ?? "Get more parenting and early education tips."}</Heading>
					...
					<div className='seasonal-banner'>
						<div className='row'>
							...
							<div className='col-12 col-lg-6 bottom'>
								<Heading level='h3'>{seasonalBanner.heading ?? "Find a Primrose School Near You"}</Heading>
								<Paragraph className='b3'>{seasonalBanner.subheading ?? "Inspire a lifelong love of learning. Contact your local Primrose to schedule a tour."}</Paragraph>
								<Button
									variant="primary"
