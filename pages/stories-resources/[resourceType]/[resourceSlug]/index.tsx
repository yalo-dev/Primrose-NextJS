...
export default function ResourceComponent({
  ...
  const resourceSlugProper: string | undefined =
    typeof resourceSlug === "string" ? resourceSlug : resourceSlug?.length[0]; // make sure resourceSlug is string | undefined
    ...
    <>
      <div className="resource">
            ...
            <div className="inner d-lg-flex align-items-lg-center justify-content-lg-center">
              ...
              <div className="content-wrapper ps-4 pe-4 position-relative">
                <div className="details d-flex justify-start align-items-center">
                  ...
                  {date && (
                    <div className="resource-date mb-0">
        ...
        <div className="social d-flex justify-content-center flex-xl-column mt-4 mb-4 mt-xl-0">
          ...
          <Link
            href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(resourceSlugProper)}&text=${encodeURIComponent(resource.title)}`}
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
          ...
          <div className="seasonal-banner">
            <div className="row">
              <div className="col-12 col-lg-6 top">
                ...
                <Image
                  src="/assets/Find_A_School_cta.jpg"
              ...
              <div className="col-12 col-lg-6 bottom">
                <Heading level="h3">
                  {seasonalBanner.heading ?? "Find a Primrose School Near You"}
                </Heading>
                <Paragraph className="b3">
                ...
                <Button
                  variant="primary"
                  label={seasonalBanner.button?.title ?? "Find A School"}
                  href={seasonalBanner.button?.url ?? "/find-a-school"}
