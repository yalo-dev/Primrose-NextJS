...
export default function ScheduleATourForm(props: Props) {
  ...
  useEffect(() => {
    ...
    if (form) {
      // TODO Update Old Switch code to something like this
      // console.dir(form)
      // const childSelection = document.getElementById('field_' + form.formFields.nodes[4].id)
      // childSelection.onchange = () => {
      //     switch (childSelection.value) {
      //         case "1":
      //             let temp = document.getElementById('gfield_' + form.formFields.nodes[5].id)
      //             console.dir(temp)
      //             temp.hidden = false
      //             if (temp.children) {
      //                 for (let x in temp.children) {
      //                     console.dir(temp.children[x])
      //                     console.dir(typeof temp.children[x])
      //                     // temp.children[x].hidden = false
      //                 }
      //             }
      //             break
      //         default:
      //             break
      //     }
      //     console.dir(childSelection.value)
      // }
      const selectField = document.getElementById(
        "field_6",
      ) as HTMLSelectElement;

      const firstChildNameGroup = document.getElementById(
        "gfield_7",
      ) as HTMLDivElement;
      const firstChildName = document.getElementById(
        "field_7",
      ) as HTMLInputElement;
      const firstChildMonthGroup = document.getElementById(
        "gfield_8",
      ) as HTMLDivElement;
      const firstChildMonth = document.getElementById(
        "field_8",
      ) as HTMLSelectElement;
      const firstChildDayGroup = document.getElementById(
        "gfield_9",
      ) as HTMLDivElement;
      const firstChildDay = document.getElementById(
        "field_9",
      ) as HTMLSelectElement;
      const firstChildYearGroup = document.getElementById(
        "gfield_10",
      ) as HTMLDivElement;
      const firstChildYear = document.getElementById(
        "field_10",
      ) as HTMLSelectElement;

      const secondChildNameGroup = document.getElementById(
        "gfield_18",
      ) as HTMLDivElement;
      const secondChildName = document.getElementById(
        "field_18",
      ) as HTMLInputElement;
      const secondChildMonthGroup = document.getElementById(
        "gfield_15",
      ) as HTMLDivElement;
      const secondChildMonth = document.getElementById(
        "field_15",
      ) as HTMLSelectElement;
      const secondChildDayGroup = document.getElementById(
        "gfield_16",
      ) as HTMLDivElement;
      const secondChildDay = document.getElementById(
        "field_16",
      ) as HTMLSelectElement;
      const secondChildYearGroup = document.getElementById(
        "gfield_17",
      ) as HTMLDivElement;
      const secondChildYear = document.getElementById(
        "field_17",
      ) as HTMLSelectElement;

      const thirdChildNameGroup = document.getElementById(
        "gfield_24",
      ) as HTMLDivElement;
      const thirdChildName = document.getElementById(
        "field_24",
      ) as HTMLInputElement;
      const thirdChildMonthGroup = document.getElementById(
        "gfield_25",
      ) as HTMLDivElement;
      const thirdChildMonth = document.getElementById(
        "field_25",
      ) as HTMLSelectElement;
      const thirdChildDayGroup = document.getElementById(
        "gfield_26",
      ) as HTMLDivElement;
      const thirdChildDay = document.getElementById(
        "field_26",
      ) as HTMLSelectElement;
      const thirdChildYearGroup = document.getElementById(
        "gfield_27",
      ) as HTMLDivElement;
      const thirdChildYear = document.getElementById(
        "field_27",
      ) as HTMLSelectElement;

      const forthChildNameGroup = document.getElementById(
        "gfield_28",
      ) as HTMLDivElement;
      const forthChildName = document.getElementById(
        "field_28",
      ) as HTMLInputElement;
      const forthChildMonthGroup = document.getElementById(
        "gfield_29",
      ) as HTMLDivElement;
      const forthChildMonth = document.getElementById(
        "field_29",
      ) as HTMLSelectElement;
      const forthChildDayGroup = document.getElementById(
        "gfield_30",
      ) as HTMLDivElement;
      const forthChildDay = document.getElementById(
        "field_30",
      ) as HTMLSelectElement;
      const forthChildYearGroup = document.getElementById(
        "gfield_31",
      ) as HTMLDivElement;
      const forthChildYear = document.getElementById(
        "field_31",
      ) as HTMLSelectElement;

      const fifthChildNameGroup = document.getElementById(
        "gfield_32",
      ) as HTMLDivElement;
      const fifthChildName = document.getElementById(
        "field_32",
      ) as HTMLInputElement;
      const fifthChildMonthGroup = document.getElementById(
        "gfield_33",
      ) as HTMLDivElement;
      const fifthChildMonth = document.getElementById(
        "field_33",
      ) as HTMLSelectElement;
      const fifthChildDayGroup = document.getElementById(
        "gfield_34",
      ) as HTMLDivElement;
      const fifthChildDay = document.getElementById(
        "field_34",
      ) as HTMLSelectElement;
      const fifthChildYearGroup = document.getElementById(
        "gfield_35",
      ) as HTMLDivElement;
      const fifthChildYear = document.getElementById(
        "field_35",
      ) as HTMLSelectElement;

      const sixthChildNameGroup = document.getElementById(
        "gfield_36",
      ) as HTMLDivElement;
      const sixthChildName = document.getElementById(
        "field_36",
      ) as HTMLInputElement;
      const sixthChildMonthGroup = document.getElementById(
        "gfield_37",
      ) as HTMLDivElement;
      const sixthChildMonth = document.getElementById(
        "field_37",
      ) as HTMLSelectElement;
      const sixthChildDayGroup = document.getElementById(
        "gfield_38",
      ) as HTMLDivElement;
      const sixthChildDay = document.getElementById(
        "field_38",
      ) as HTMLSelectElement;
      const sixthChildYearGroup = document.getElementById(
        "gfield_39",
      ) as HTMLDivElement;
      const sixthChildYear = document.getElementById(
        "field_39",
      ) as HTMLSelectElement;
  ...
  return <GravityForm form={form} hiddenFields={props} />;
}
