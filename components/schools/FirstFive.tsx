...
export default function FirstFive({
  ...
  const whichStaffImage = adminSettings?.meetStaffImage?.mediaItemUrl
    ? {
        sourceUrl: adminSettings?.meetStaffImage?.mediaItemUrl,
        altText: "staff image",
      }
  ...
  const selectedOfferings =
    selectedExtraCare != "None"
      ...
      : selectedClassrooms;
  const sortedSelectedOfferings =
    selectedOfferings && selectedOfferings.includes("Summer Adventure Club")
      ? [...selectedOfferings].sort((a, b) => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 heading-wrapper">
              <h2 className="h1">
                {corporateSettings?.homepageSubheadline?.title}
              </h2>
              <div className="b3">
                {corporateSettings?.homepageSubheadline?.description?.replace(
                  "[CITY]",
            ...
            <div className="classrooms">
              <div className="two-columns-image-and-text-alternative">
                ...
                <div className="right-column col-12 col-lg-5 offset-lg-1">
                  ...
                  <div className="blurb">
                    Our time-tested approach to early childhood education is
                    designed to foster good character and grow social and
                    emotional skills while also building literacy, and math
                    skills.
                  </div>
            ...
            {adminSettings?.franchiseOwner?.bio ? (
              <FranchiseOwnerBio
                franchiseOwner={adminSettings.franchiseOwner}
              />
            ) : (
              <div className="staff">
                <div className="two-columns-image-and-text-alternative reverse-column">
                  <div className="left-column col-12 col-lg-5 offset-lg-1">
                    {whichStaffImage?.sourceUrl && (
                      <Image
                        priority
                  ...
                  <div className="right-column col-12 col-lg-5 offset-lg-1">
                    ...
                    <div className="blurb">
                      When children feel safe, loved and confident, they can
                      learn and grow to their fullest potential. That’s why
                      Primrose school teachers and staff are dedicated to
                      creating an environment that helps lay the foundation for
                      a lifelong love of learning.
                    </div>
                    <Button href={schoolSlug + "/staff"}>Learn More</Button>
                  </div>
                </div>
              </div>
            )}
