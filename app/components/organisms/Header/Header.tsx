...
export default function Header({ menuItems }) {
  ...
  const renderMenuItem = (item, index) => {
    ...
    return (
      <li
        key={key}
        className={`nav-item ${hasChildren ? "has-children" : ""} ${item.cssClasses}`}
      >
        <Link
          className="parent-item nav-link d-none d-lg-flex"
          href={item.url}
          passHref
        ...
        <div
          className="parent-item nav-link d-flex d-lg-none justify-content-between align-items-center"
        ...
        {hasChildren && (
          <div
            className={`submenu ${isSubmenuActive ? "show" : ""}`}
            style={submenuStyles || undefined}
          >
            <div className={`container`}>
              ...
              <ul
                className={`${twoColumns ? "double-column" : ""} ${threeColumns ? "triple-column" : ""}`}
              >
                  ...
                  <button>
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M5.34278 9.48477C5.6479 9.23335 5.68913 8.78495 5.43486 8.48324L2.23987 4.69213L5.41452 1.23907C5.68169 0.94847 5.66003 0.498731 5.36615 0.234549C5.07226 -0.0296345 4.61743 -0.0082178 4.35026 0.282382L1.17561 3.73545C0.692786 4.26061 0.675427 5.05738 1.13493 5.60261L4.32992 9.39373C4.58419 9.69543 5.03766 9.7362 5.34278 9.48477Z"
                        fill="#5E6738"
                      />
                    </svg>
                  </button>
                ...
                {item.childItems.nodes.map((childItem, childIndex) => (
                  <li
                    key={`child-${childItem.label}-${childItem.url}-${childIndex}`}
                    className={`${childItem.cssClasses} nav-item`}
                  >
                    <Link
                      className="nav-link"
                      href={childItem.url}
  ...
  useEffect(() => {
    ...
    const positionSubmenu = () => {
      let currentSubmenuPos = document
    ...
    document
      .querySelector(".mobile-location-icon")
  ...
  return (
    <header className="header">
      <nav
        className={`navbar navbar-expand-lg fixed-top ${isDesktopSearchActive ? "show" : ""}`}
      >
          ...
          >
            <div className="container p-0 h-100">
              <div className="nav-wrapper d-flex flex-column flex-lg-row justify-content-start justify-content-lg-between align-items-lg-center h-100">
                ...
                <div
                  className={`navbar-search mt-4 mt-lg-0 pb-4 pb-lg-0 order-1 order-lg-2 ${isSearchActive ? "active" : ""}`}
                >
                  <form
                  ...
                  >
                    ...
                    <div
                      className={`clear-icon ${inputText && isSearchActive ? "show" : ""}`}
                      onClick={clearInput}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      >
                        ...
                        <path
                          d="M12.1211 7.87866L7.87845 12.1213"
                          stroke="#5E6738"
                        />
                        <path
                          d="M7.87891 7.87866L12.1215 12.1213"
                          stroke="#5E6738"
                        />
                      </svg>
                    </div>
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M13.8947 7.81579C13.8947 11.1731 11.1731 13.8947 7.81579 13.8947C4.45848 13.8947 1.73684 11.1731 1.73684 7.81579C1.73684 4.45848 4.45848 1.73684 7.81579 1.73684C11.1731 1.73684 13.8947 4.45848 13.8947 7.81579ZM12.8913 13.7595C11.5257 14.9267 9.75308 15.6316 7.81579 15.6316C3.49925 15.6316 0 12.1323 0 7.81579C0 3.49925 3.49925 0 7.81579 0C12.1323 0 15.6316 3.49925 15.6316 7.81579C15.6316 9.56904 15.0543 11.1875 14.0794 12.4913L17.7284 16.1403L16.5003 17.3685L12.8913 13.7595Z"
                          fill="#5E6738"
                        />
                      </svg>
                    </a>
                    <button
                      className={`search-submit ${isSearchActive ? "active" : ""}`}
                      type="submit"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                      className={`find-a-school-button ${isSearchActive ? "active" : ""}`}
                    >
                    ...
                    <a
                      href="/find-a-school"
                      className={`mobile-location-icon ${isSearchActive ? "active" : ""}`}
                    >
                      <div>
                        <svg
                          width="24"
