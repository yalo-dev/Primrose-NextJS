...
const Subheading: React.FC<SubheadingProps> = ({
  ...
  switch (level) {
    case "h2":
      return <h2 className={className}>{coloredChildren}</h2>;
    case "h3":
      return <h3 className={className}>{coloredChildren}</h3>;
    case "h4":
      return <h4 className={className}>{coloredChildren}</h4>;
    case "h5":
      return <h5 className={className}>{coloredChildren}</h5>;
    case "h6":
      return <h6 className={className}>{coloredChildren}</h6>;
    case "div":
      return <div className={className}>{coloredChildren}</div>;
    default:
      return <span>{coloredChildren}</span>;
  }
};
