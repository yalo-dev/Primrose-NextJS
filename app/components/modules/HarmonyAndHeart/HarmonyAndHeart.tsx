...
const HarmonyAndHeart: React.FC<HarmonyAndHeartProps> = ({
  leftColumn,
  moduleId,
  rightHarmonyColumn,
}) => {
  ...
  return (
    <div className="container">
      <div
        className={`harmony-and-heart row ${isSticky ? "sticky" : ""}`}
        ref={pathwayRef}
      >
        <div className="left-harmony-column col-lg-4 ">
          <div className="wrap mt-4">
            ...
            <Subheading
              level={"h4"}
              children={leftColumn.subHeading}
            ></Subheading>
                ...
                <div className="music-player-container">
                  <div className="row">
                    ...
                    <div className="info-container justify-content-center">
                      <p className="artist b2">
                        {leftColumn.musicPlayer?.artistAuthor}
                      </p>
                      <p className="track-title b2">
                        {leftColumn.musicPlayer?.trackTitle}
                      </p>
                    </div>
                    <audio
                      controls
                    ...
                    >
                      <source
                        src={leftColumn.musicPlayer?.audio?.url}
                        type="audio/mp3"
                      />
            ...
            <div key={index} className="container music-collection-item">
              <div className="row music-row mb-3">
                <div className="col-4 col-md-6 music-left-column">
                  <img
                    src={collection?.image?.sourceUrl}
                ...
                <div className="col-8 col-md-6 music-right-column">
                  <div className="content-container">
                    <div className="d-flex flex-column justify-content-center h-100">
                      {" "}
                      {/* Center vertically */}
                      <Heading level="h4" className="music-head text-left">
                        {collection?.title}
                      </Heading>
                      <div
                      ...
                      {collection?.spotifyLink?.url && (
                        <div className="music-container mt-4 d-md-block">
                          <div className="music-buttons-row">
                            ...
                            {collection.spotifyLink?.url && (
                              <div
                                className={`music-button ${hoverEffectClass}`}
                              >
                                <button
                                  onClick={() =>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    />
                                    <image
                                      xlinkHref="https://settings.primroseschools.com/wp-content/uploads/2024/01/Object.png"
                                      x="15"
                                      y="15"
                                      width="20"
                                      height="20"
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    />
                                    <image
                                      xlinkHref="https://settings.primroseschools.com/wp-content/uploads/2024/01/Object2.png"
                                      x="15"
                                      y="15"
                                      width="20"
                                      height="20"
