      ...
      <div className='resource'>
        ...
        <div className='social d-flex justify-center flex-xl-column mt-4 mb-4'>
          ...
          <Link href="#" target="_blank" rel="noopener noreferrer">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle opacity="0.2" cx="20" cy="20" r="19.5" stroke="#373A36" stroke-dasharray="2 2" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M25.4 24.3561H22.8804V20.7155C22.8804 19.7626 22.4863 19.112 21.6197 19.112C20.9568 19.112 20.5881 19.551 20.4165 19.9741C20.3522 20.126 20.3622 20.3375 20.3622 20.549V24.3561H17.8661C17.8661 24.3561 17.8983 17.9071 17.8661 17.3209H20.3622V18.4251C20.5097 17.9423 21.3073 17.2533 22.5802 17.2533C24.1593 17.2533 25.4 18.2652 25.4 20.4443V24.3561ZM15.3419 16.441H15.3258C14.5215 16.441 14 15.9032 14 15.2215C14 14.5265 14.5369 14 15.3573 14C16.177 14 16.6811 14.5252 16.6972 15.2195C16.6972 15.9012 16.177 16.441 15.3419 16.441ZM14.2875 17.3209H16.5095V24.3561H14.2875V17.3209Z" fill="#373A36" />
            </svg>
          </Link>
        </div>
