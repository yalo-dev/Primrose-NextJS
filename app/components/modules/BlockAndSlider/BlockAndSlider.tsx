    ...
    <div className="block-and-slider">
      <div className="container">
        <div
          className="row"
          style={{
            marginTop: customizations?.topMarginDesktop,
            marginBottom: customizations?.bottomMarginDesktop,
          }}
        >
          <div className="col">
        ...
        <div
          className="row"
          style={{
            marginTop: customizations?.topMarginMobile,
            marginBottom: customizations?.bottomMarginMobile,
          }}
        >
