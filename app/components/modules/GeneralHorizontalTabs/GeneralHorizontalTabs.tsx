...
const HorizontalTab: React.FC<HorizontalTabProps> = ({
  ...
  const buttonsRefGH = useRef<(HTMLButtonElement | null)[][]>(
    tabs?.map(() => []),
  );
  ...
  useEffect(() => {
    const handleScrollGH = () => {
      if (containerRefGH.current) {
        ...
        const lastContentOffset = document
          .querySelector(".general-horizontal-tabs .desktop-content:last-child")
  ...
  const springInAnimation = useSpring({
    ...
    delay: 500,
    transform:
      expandedTabGH !== null ? "translateX(0px)" : "translateX(-250px)",
  ...
  const handleIconClickGH = (
    ...
    if (isCloseIconClicked) {
      ...
      targetButton &&
      targetButton.classList.contains("has-popup") &&
      activePopupGH !== uniqueId &&
      !isDetailsPopupClicked
    ) {
  ...
  return (
    <div
      className={`container ${isStickyGH ? "sticky" : ""}`}
      ref={containerRefGH}
    >
      <Customizations
            ...
            {tabs?.map((tab, index) => (
              <div key={index}>
                <button
                  ...
                  id={`button-${index}`}
                  className={
                    expandedTabGH === index ? "clickable expanded" : "clickable"
                  }
                >
                  {tab.label && (
                ...
                <div className="d-lg-none">
                  {expandedTabGH === index && (
                    <animated.div
                      style={springInAnimation}
                      className="tab-content"
                      ref={(el) => (contentRefsGH.current[index] = el)}
                    >
                      ...
                      <div className="content-wrapper">
                        {tab.content.heading && (
                          <Heading
                            ...
                            color={tab.content.headingColor}
                          >
                            {tab.content.heading}
                          </Heading>
                        )}
                        {tab.content.subheading && (
                          <Subheading
                            level="div"
                            className="b3"
                            color={tab.content.subheadingColor}
                          >
                            {tab.content.subheading}
                          </Subheading>
                        )}
                            ...
                            <li key={idx}>
                              <div className="icon-and-popup-container d-flex flex-lg-column align-center justify-content-lg-center">
                                ...
                                <span
                                  ...
                                  className={`ps-4 icon-container-headline-mobile ${activePopupGH === `${index}-${idx}` ? "active" : ""} ${item.detailsPopUp ? "has-popup" : ""}`}
                                  color={item.textColor}
                                >
                                  {item.text}
                                </span>
                                <div
                                  className={`details-popup ${activePopupGH === `${index}-${idx}` ? "active" : ""}`}
                                >
                                  <div className="title-container">
                                    {item.text && (
                                      <Subheading level="div" className="title">
                                        {item.text}
                                      </Subheading>
                                    )}
                                    <div
                                    ...
                                    >
                                      ...
                                      >
                                        <circle
                                          ...
                                          cy="21.2129"
                                          r="14.25"
                                          transform="rotate(-45 22.0023 21.2129)"
                                          stroke="#fff"
                                          strokeWidth="1.5"
                                        />
                                        <path
                                          d="M25.1875 18.0312L18.8235 24.3952"
                                          stroke="#fff"
                                          strokeWidth="1.5"
                                        />
                                        <path
                                          d="M18.8203 18.0312L25.1843 24.3952"
                                          stroke="#fff"
                                          strokeWidth="1.5"
                                        />
                                      </svg>
          ...
          <div className="desktop-content d-none d-lg-block">
            {tabs?.map((tab, index) => (
              ...
              >
                ...
                <div className="content-wrapper">
                  {tab.content.heading && (
                    <Heading level="h3" color={tab.content.headingColor}>
                      {tab.content.heading}
                    </Heading>
                  )}
                  {tab.content.subheading && (
                      ...
                      <li key={idx}>
                        <div className="icon-and-popup-container d-flex flex-lg-row align-center justify-content-lg-center">
                          ...
                          <span
                            ...
                            className={`ps-4 icon-container-headline ${activePopupGH === `${index}-${idx}` ? "active" : ""} ${item.detailsPopUp ? "has-popup" : ""}`}
                            color={item.textColor}
                          >
                            {item.text}
                          </span>
