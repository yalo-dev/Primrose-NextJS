...
const ContentWithSchoolhouse: React.FC<ContentWithSchoolhouseProps> = ({ eyebrow, eyebrowColor, heading, headingColor, subheading, subheadingColor, list, customizations }) => {
    ...
    return (
	   ...
	   >
            <div className="contentwithschoolhouse">
