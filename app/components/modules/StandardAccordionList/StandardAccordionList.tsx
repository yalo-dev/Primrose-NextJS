...
const StandardAccordionList: React.FC<StandardAccordionListProps> = ({
  heading,
  headingColor,
  accordion,
  footnote,
          ...
          <div className="inner col-lg-11 offset-lg-1">
            ...
            <div className="row accordions">
              {accordion.map((accordion, index) => {
                const fadeIn = useSpring({
                  ...
                  maxHeight:
                    expandedAccordionIndex === index ? "1000px" : "0px",
                  overflow: "hidden",
                });
            ...
            {footnote && (
              <div className="footnote d-flex flex-column flex-lg-row pt-4">
                <Paragraph className="b3" color={footnoteColor}>
                  <i>{footnote}</i>
                </Paragraph>
              </div>
            )}
