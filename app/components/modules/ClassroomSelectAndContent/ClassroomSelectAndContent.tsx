...
const ClassroomSelectAndContent: React.FC<ClassroomSelectAndContentProps> = ({
  accents,
  leftColumn,
  rightColumn,
  customizations,
    ...
    <div className="container">
      ...
      >
        <div className="classroom-select-and-content">
          <div
            className="left-column col-12 col-lg-7"
            style={{
              backgroundColor:
                colorMap[customizations?.backgroundColorLeft || ""],
            }}
          >
            <div className="content-wrap">
              ...
              {leftColumn.subheading && (
                <Subheading
                  level="div"
                  className="b3"
                  color={leftColumn.subheadingColor}
                >
                  {leftColumn.subheading}
                </Subheading>
              )}
              {leftColumn.button?.url && (
                <Button
                  variant={leftColumn.buttonStyle || "primary"}
                  href={leftColumn.button.url}
                  target={leftColumn.button.target || "_self"}
                >
            ...
            {leftColumn.image?.sourceUrl && (
              <Image
                width={1920}
                height={1920}
                src={leftColumn.image.sourceUrl}
                alt={leftColumn.image.altText}
              />
            )}
          </div>
          <div
            className="right-column col-12 col-lg-5"
            style={{
              backgroundColor:
                colorMap[customizations?.backgroundColorRight || ""],
            }}
          >
            {rightColumn.heading && (
              <Heading level="h2" color={rightColumn.headingColor}>
                {rightColumn.heading}
              </Heading>
            )}
            {rightColumn.subheading && (
              <Subheading
                level="div"
                className="b3"
                color={rightColumn.subheadingColor}
              >
                {rightColumn.subheading}
              </Subheading>
            )}
            ...
            <div className="accent">
              <div
                ...
                style={{
                  backgroundImage: `url('${accents.accentOne?.sourceUrl}')`,
                }}
              ></div>
              <div
                className="accent-two"
                style={{
                  backgroundImage: `url('${accents.accentTwo?.sourceUrl}')`,
                }}
              ></div>
            </div>
          </div>
