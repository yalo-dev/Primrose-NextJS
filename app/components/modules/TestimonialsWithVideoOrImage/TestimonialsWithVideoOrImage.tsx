...
const TestimonialsWithVideoOrImage: React.FC<
  TestimonialsWithVideoOrImageProps
> = (props) => {
  const {
    buttonStyle,
    button,
  ...
  const sliderContent = slider?.some((slide) => slide.image)
    ? "has-image-or-video"
    : "";
              ...
              {slider?.map((slide, index) => (
                <div key={index} className="slider-item">
                  <div className="media-wrap">
                    {slide.imageOrVideo === "image" &&
                      slide.image?.sourceUrl && (
                        <div className="image-wrap">
                          <img
                            src={slide.image.sourceUrl}
                            alt={slide.image.altText || "Slide image"}
                            width={500}
                            height={300}
                          />
                        </div>
