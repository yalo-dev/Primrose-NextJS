            ...
            <div className="right-column col-12 col-lg-6">
              {rightColumn.eyebrow && (
                <Subheading
                  level="div"
                  className="h5"
                  color={rightColumn.eyebrowColor}
                >
                  {rightColumn.eyebrow}
                </Subheading>
              )}
              {rightColumn.heading && (
                <Heading level="h1" color={rightColumn.headingColor}>
                  {rightColumn.heading}
                </Heading>
              )}
              {rightColumn.subheading && (
                <Subheading level="h5" color={rightColumn.subheadingColor}>
                  {rightColumn.subheading}
                </Subheading>
              )}
              {rightColumn?.blurb && (
                <Paragraph className="b2" color={rightColumn.blurbColor}>
                  {parse(rightColumn.blurb)}
                </Paragraph>
              )}
              {rightColumn.button?.url && rightColumn.button.title && (
                <Button
                  ...
                  target={rightColumn.button.target || "_self"}
