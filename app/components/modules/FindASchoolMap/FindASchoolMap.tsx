...
const transformSchoolData = (schoolData) => {
  ...
  if (schoolData.schoolCorporateSettings.corporateChildcare) {
    notes.push(
      `Corporate Childcare: ${schoolData.schoolCorporateSettings.corporateChildcare}`,
    );
  }
  ...
  if (schoolData.schoolCorporateSettings.openingIn?.season) {
    notes.push(
      `Opening In: ${schoolData.schoolCorporateSettings.openingIn.season}`,
    );
  }
  ...
  return {
    ...
    notes: notes.join(", "),
    phoneNumber: schoolData.schoolCorporateSettings.phoneNumber,
    coordinates: {
      lat: schoolData.schoolCorporateSettings.address.latitude,
      lng: schoolData.schoolCorporateSettings.address.longitude,
    },
  };
};
...
const FindASchoolMap: React.FC<FindASchoolMapProps> = (props) => {
  ...
  return (
    ...
    >
      <div
        id="map"
        className={"find-a-school-cms-container " + (title ? "title" : "")}
      >
        {heading && (
          <div
            className="map-title"
            style={{ color: headingColor, backgroundColor: backgroundColor }}
          >
            <h3>{heading}</h3>
          </div>
        )}
                ...
                <div className="input-wrapper">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M24.5332 24.7798L29.7559 30.0025"
                        stroke="white"
                      />
                    </svg>
                  </div>
                            ...
                            return (
                              <div key={waypoint.id} className="waypoint-input">
                                ...
                                <div
                                  className="clear-icon"
                                  onClick={() =>
                                    handleClearIconClick(waypoint.id)
                                  }
                                >
                                  <svg
                                    width="30"
                        ...
                        >
                          ...
                          <div className="button-wrap d-flex">
                            <button
                              ...
                              onClick={() =>
                                (window.location.href = `${school.slug}/schedule-a-tour`)
                              }
                            >
                              Schedule a Tour
                            </button>
              ...
              {waypoints &&
                waypoints
                  .filter(
                    (
                      waypoint,
                    ): waypoint is { id: number; location: Location } =>
