...
const Customizations: React.FC<CustomizationsProps> = ({
  ...
  const mapPaddingValue = (
    mobilePadding: string | undefined,
    desktopPadding: string | undefined,
    isMobile: boolean,
  ) => {
  ...
  const mapMarginValue = (
    mobileMargin: string | undefined,
    desktopMargin: string | undefined,
    isMobile: boolean,
  ) => {
  ...
  const outerBackgroundColor = isMounted
    ? mapColorToHexOuter(colorLabelOuter)
    : "";
  ...
  return (
    <div
      style={{ ...paddings, ...margins, backgroundColor: outerBackgroundColor }}
    >
